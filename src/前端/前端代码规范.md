...
格式：分支类型_版本号_年月日
示例：
release命名格式：“release_1.0.0_yyyymmdd"
Hotfix命名格式："hotfix_1.0.1_yyyymmdd"
...
1. hotfix 分支：用于支持紧急需求、产线缺陷修复生产环境发布
...
示例：git commit -m 'fix：修复了xxx组件时间显示乱码问题'